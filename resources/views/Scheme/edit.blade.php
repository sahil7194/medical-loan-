...
@section('title')
    Edit Schemes {{ $scheme->title }}
@endsection

@section('content')

    <div>
        <form class="w-1/2" action="{{url('schemes/'.$scheme->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="space-y-12">
                <div class=" pb-12">
                    <h2 class="text-base/7 font-semibold text-gray-900">Edit Scheme</h2>
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-2">
                                <input id="title" name="title" type="text" autocomplete="title" value="{{ $scheme->title }}"
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-2">
                                <textarea name="description" id="description" rows="3"
                                    class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">{{ $scheme->description }}
                                </textarea>
                            </div>
                ...
                <div class=" pb-12 border-b border-gray-900/10">
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input type="number" name="min_interest_rate" id="min_interest_rate" value="{{ $scheme->min_interest_rate }}"
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input type="number" name="max_interest_rate" id="max_interest_rate" value="{{ $scheme->max_interest_rate }}"
                                    class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input type="number" name="min_cibil" id="min_cibil" autocomplete="given-name" value="{{ $scheme->min_cibil}}"
                                    class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input type="number" name="max_cibil" id="max_cibil" autocomplete="family-name" value="{{ $scheme->max_cibil}}"
                                    class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input type="text" name="min_tenure" id="min_tenure" autocomplete="given-name" value="{{ $scheme->min_tenure }}"
                                    class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input type="text" name="max_tenure" id="max_tenure" autocomplete="family-name" value="{{ $scheme->max_tenure }}"
                                    class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input type="text" name="min_amount" id="min_amount" autocomplete="given-name" value="{{ $scheme->min_amount }}"
                                    class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input type="text" name="max_amount" id="max_amount" autocomplete="family-name" value="{{ $scheme->max_amount }}"
                                    class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                            </div>
                        </div>
                    </div>
